...
from .us_states import full2abbr, STATES_ABBR, STATES_FULL
from .us_zips import zip2city, zip2state
...
_STREET_2_REGEX = re.compile(
    r'(apartment|apt\.?|suite|\#)( ?\#?\d+)', re.IGNORECASE)
